...
public class Node {
    ...
    public List<Edge> getVehicleEdgesOutgoing(int vehicle){
        List<Edge> outgoingEdgesCopy = new ArrayList<Edge>();
        for(Edge e: outgoingEdges){
            if(e.getVehicleWeight(vehicle) != 0){
                outgoingEdgesCopy.add(e);
            }
        }
